...
/**
 * The letter a space's square avatar shows. Spaces carry no icon or colour
 * field, so the chrome derives both from what a space does have: its name for
 * the letter, its entity id for a stable colour (below).
 */
