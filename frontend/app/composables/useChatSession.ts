 ...
 * typed and not sent, how far down they have read, what they scoped the
 * retrieval to, and the scope each question went out under — one entry per
 * question, in the order they were sent, `null` for the whole knowledge base.
 */
type PanelSession = ChatSession & {
  unsent: Ref<string>
  scrollTop: Ref<number>
  scope: Ref<string>
  askedScopes: Ref<Array<string | null>>
}
