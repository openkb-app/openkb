...
import { spaceColor, spaceInitials } from '#shared/utils/kb-spaces'
      ...
      <div v-if="!showIconRail(collapsed)" class="flex flex-col gap-2">
        ...
        <div class="flex min-h-11 w-full items-center rounded-md border border-default bg-default text-sm hover:border-accented">
          ...
          >
            ...
            >{{ spaceInitials(activeSpace.name) }}</span>
          </NuxtLink>
        ...
        <NuxtLink
          ...
          class="flex items-center gap-2 rounded-md px-2.5 py-1.5 text-sm font-medium text-toned hover:bg-elevated focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-(--ui-primary)"
        >
