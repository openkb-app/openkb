 ...
 *                               moderation?: boolean, agentReview?: boolean }
...
export default defineEventHandler(async (event) => {
  ...
  const settings: SpaceSettings = {
    ...
    moderation: flag(body?.moderation, 'moderation'),
    agentReview: flag(body?.agentReview, 'agentReview'),
  }
  if (settings.managers === undefined && settings.members === undefined
    ...
    && settings.agentReview === undefined) {
